...
def main() -> None:
    ...
    idf = subparsers.add_parser(
        "idf", help="Calculate Inverse Document Frequency(IDF)"
    )
    idf.add_argument("term", type=str, help="Term to calculate IDF")

    tf_idf_parser = subparsers.add_parser(
        "tfidf", help="Calculate TF-IDF for document id based on the term"
    )
    ...
    bm25_idf_parser = subparsers.add_parser(
        "bm25idf", help="Calculate BM25 IDF for a term"
    )
    bm25_idf_parser.add_argument("term", type=str, help="Term to calculate bm25 idf")

    bm25_tf_parser = subparsers.add_parser(
        "bm25tf", help="Calculate BM25 TF for the doc and term"
    )
